...
import { add9 } from '../fn/ordre-mission/add-9';
import { Add9$Params } from '../fn/ordre-mission/add-9';
import { delete9 } from '../fn/ordre-mission/delete-9';
import { Delete9$Params } from '../fn/ordre-mission/delete-9';
import { findAll9 } from '../fn/ordre-mission/find-all-9';
import { FindAll9$Params } from '../fn/ordre-mission/find-all-9';
import { findById9 } from '../fn/ordre-mission/find-by-id-9';
import { FindById9$Params } from '../fn/ordre-mission/find-by-id-9';
import { OrdreMissionDto } from '../models/ordre-mission-dto';
import { update9 } from '../fn/ordre-mission/update-9';
import { Update9$Params } from '../fn/ordre-mission/update-9';

@Injectable({ providedIn: 'root' })
export class OrdreMissionService extends BaseService {
