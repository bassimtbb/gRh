...
import { loadUserByUsername1 } from '../fn/user-detail-imp-controller/load-user-by-username-1';
import { LoadUserByUsername1$Params } from '../fn/user-detail-imp-controller/load-user-by-username-1';
import { UserDetails } from '../models/user-details';

@Injectable({ providedIn: 'root' })
export class UserDetailImpControllerService extends BaseService {
