...
export function add4(http: HttpClient, rootUrl: string, params: Add4$Params, context?: HttpContext): Observable<StrictHttpResponse<DepartementDto>> {
