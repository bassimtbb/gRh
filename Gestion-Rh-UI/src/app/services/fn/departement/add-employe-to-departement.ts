...
export function addEmployeToDepartement(http: HttpClient, rootUrl: string, params: AddEmployeToDepartement$Params, context?: HttpContext): Observable<StrictHttpResponse<Departement>> {
