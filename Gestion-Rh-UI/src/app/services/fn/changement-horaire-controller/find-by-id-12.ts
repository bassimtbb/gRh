...
export function findById12(http: HttpClient, rootUrl: string, params: FindById12$Params, context?: HttpContext): Observable<StrictHttpResponse<ChangementHoraireDto>> {
...
findById12.PATH = '/ChangementH/{id}';
