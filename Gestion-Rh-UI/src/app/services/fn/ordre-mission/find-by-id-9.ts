...
export function findById9(http: HttpClient, rootUrl: string, params: FindById9$Params, context?: HttpContext): Observable<StrictHttpResponse<OrdreMissionDto>> {
...
findById9.PATH = '/OrdreMission/{id}';
