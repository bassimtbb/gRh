...
export function add13(http: HttpClient, rootUrl: string, params: Add13$Params, context?: HttpContext): Observable<StrictHttpResponse<AutorisationSortieDto>> {
