...
export function findAll13(http: HttpClient, rootUrl: string, params?: FindAll13$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<AutorisationSortieDto>>> {
...
findAll13.PATH = '/AutorisationS/all';
