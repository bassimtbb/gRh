...
export function update11(http: HttpClient, rootUrl: string, params: Update11$Params, context?: HttpContext): Observable<StrictHttpResponse<CongeDto>> {
