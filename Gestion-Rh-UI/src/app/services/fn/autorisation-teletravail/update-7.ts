...
export function update7(http: HttpClient, rootUrl: string, params: Update7$Params, context?: HttpContext): Observable<StrictHttpResponse<AutorisationTeletravailDto>> {
