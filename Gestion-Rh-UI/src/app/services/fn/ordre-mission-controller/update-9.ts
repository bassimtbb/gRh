...
export function update9(http: HttpClient, rootUrl: string, params: Update9$Params, context?: HttpContext): Observable<StrictHttpResponse<OrdreMissionDto>> {
