...
export function update10(http: HttpClient, rootUrl: string, params: Update10$Params, context?: HttpContext): Observable<StrictHttpResponse<OrdreMissionDto>> {
