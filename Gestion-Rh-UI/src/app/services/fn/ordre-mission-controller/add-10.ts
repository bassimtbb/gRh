...
export function add10(http: HttpClient, rootUrl: string, params: Add10$Params, context?: HttpContext): Observable<StrictHttpResponse<OrdreMissionDto>> {
