...
//    @Query("SELECT COUNT(c) FROM AutorisationTravailSup c JOIN c.departement d WHERE d.id = :departementId AND c.statut = :statut")
//    Integer countStatutByDepartementId(@Param("departementId") Long departementId, @Param("statut") Statut statut);
//
//    @Query("SELECT COUNT(c) FROM AutorisationTravailSup ")
//    Integer countAll();
//
//    @Query("SELECT COUNT(c) FROM AutorisationTravailSup c JOIN c.departement d WHERE d.id = :departementId ")
